...
public class Main extends SolutionRunner<Integer, Solution> {
    ...
    protected ArrayList<TestCase<Integer>> getTestCases() {
        ...
        cases.add(new TestCase<Integer>("LeetCode Example 3", 2, new Object[] {
                new int[] { 1, 1, 1 }
        }));
        cases.add(new TestCase<Integer>("Includes Last Element", 4, new Object[] {
                new int[] { 1, 0, 1, 1, 1, 0, 1 }
        }));
        cases.add(new TestCase<Integer>("Includes First Element", 4, new Object[] {
